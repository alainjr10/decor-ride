...
Either<AuthValueFailure<String>, String> validateEmailAddress({
  ...
  if (emailRegex.hasMatch(email!)) {
    ...
    return left(
      AuthValueFailure.invalidEmail(failedValue: email),
    );
  }
}

Either<AuthValueFailure<String>, String> validatePassword({
